...
프로젝트 주제 및 목적 — InventoCook

InventoCook은 냉장고 식재료를 체계적으로 관리하고, 유통기한 정보를 기반으로 메뉴를 추천하는 데스크탑 애플리케이션입니다.
사용자가 보유한 식재료의 등록·조회·수정 기능을 제공하며, 유통기한 임박 재료를 우선적으로 활용할 수 있는 레시피를 자동 추천함으로써
✔ 음식물 쓰레기 감소
✔ 경제적 손실 최소화
✔ 식품 안전 확보
✔ 메뉴 선택 부담 감소
